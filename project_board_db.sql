CREATE DATABASE  IF NOT EXISTS `project_board` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `project_board`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: project_board
-- ------------------------------------------------------
...
-- Dump completed on 2017-09-22 20:58:27
